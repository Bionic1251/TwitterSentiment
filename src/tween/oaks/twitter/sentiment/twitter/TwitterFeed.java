...
public class TwitterFeed {
    private static String TWITTER_OAUTH_CONSUMER_KEY = "";
    private static String TWITTER_OAUTH_CONSUMER_SECRET = "";
    private static String TWITTER_OAUTH_ACCESS_TOKEN = "";
    private static String TWITTER_OAUTH_ACCESS_TOKEN_SECRET = "";
